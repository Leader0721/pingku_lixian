...
public class RuKuDMXDto extends BaseModel {
    @Column
    private int id_rukudmx;
    @Column
    private String id_rukudmxckxt;
    @Column
    private String rukudmxid;
    @Column
    ...
    public String getRukudmxid() {
        return rukudmxid;
    }

    public void setRukudmxid(String rukudmxid) {
        this.rukudmxid = rukudmxid;
    }
